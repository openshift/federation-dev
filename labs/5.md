...
>NOTE: If you recieve the error `curl: (6) Could not resolve host:` wait a few moments and try the command again. This occurs when the LoadBalancer is still being created and the health checks are being ran before making the Load Balancer active.
