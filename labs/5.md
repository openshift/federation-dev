...
We are going to use **vim** editor, for each file you need to follow these steps:

1. vim `<file>`
2. Press `i` to enter *INSERT* mode
3. Paste content
4. Press `esc` to exit *INSERT* mode
5. Save and exit typing `:wq`
...
Primary member will have `stateStr` property set to _PRIMARY_ whereas secondary members will have the property set to _SECONDARY_.

As an alternative you can run these commands which will show primary and secondary members:
