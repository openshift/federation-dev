...
~~~sh
# The command below will display objects in the dev-web-site namespace
oc --context cluster1 -n dev-web-site get deployments,services,pods,routes

NAME                                       READY   UP-TO-DATE   AVAILABLE   AGE
deployment.extensions/dev-the-deployment   1/1     1            1           72s

NAME                      TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)    AGE
service/dev-the-service   ClusterIP   172.30.120.25   <none>        8080/TCP   72s

NAME                                      READY   STATUS    RESTARTS   AGE
pod/dev-the-deployment-5fc896d994-wvxp7   1/1     Running   0          72s

NAME                                     HOST/PORT                                                                 PATH   SERVICES      PORT   TERMINATION   WILDCARD
route.route.openshift.io/dev-the-route   kustomized-app.apps.cluster-brno-206e.brno-206e.sandbox1012.opentlc.com          the-service   8080                 None
~~~
