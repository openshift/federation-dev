...
The files within the [directory](./lab-5-assets) are used to deploy
...
1. Change directory to `lab-5-assets`
...
~~~sh
argocd app create --project default --name cluster1-mongo --repo https://github.com/openshift/federation-dev.git --path labs/lab-6-assets --dest-server https://kubernetes.default.svc  --dest-namespace mongo  --revision master --sync-policy automated
argocd app create --project default --name cluster2-mongo --repo https://github.com/openshift/federation-dev.git --path labs/lab-6-assets --dest-server https://api.east-2.sysdeseng.com:6443  --dest-namespace mongo  --revision master --sync-policy automated
argocd app create --project default --name cluster3-mongo --repo https://github.com/openshift/federation-dev.git --path labs/lab-6-assets --dest-server https://api.west-2.sysdeseng.com:6443 --dest-namespace mongo  --revision master --sync-policy automated
~~~
...
Next Lab: [Lab 7 - Deploying Pacman](./6.md)<br>
